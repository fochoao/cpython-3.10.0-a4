...
<p>
    <a href="https://www.infoworld.com/d/application-development/van-rossum-python-not-too-slow-188715">It&#8217;s generally less of a problem than one would expect.</a>
...
<p>
You can <code>:set content.javascript.can_access_clipboard true</code>, or
<code>:set -u some.domain content.javascript.can_access_clipboard true</code> if you want to limit
the setting to <code>some.domain</code>.
</p>
</li>
</ol></div>
</div>
