...
class Titlebar(QWidget):
    ...
    def __init__(self, parent, icon_name, icon_jpg):
        super(Titlebar, self).__init__(parent)
        self.parentwidget = parent
        self.setFixedHeight(Titlebar.TITLEBAR_HEIGHT)
        self.icon_name = icon_name
        self.icon_jpg = icon_jpg
    ...
    def closer(self,choose):
        ...
        if choose == True:
            ...
            if os.path.exists(self.icon_jpg):
                self.icon = QIcon(self.icon_jpg)
            else:
                QMessageBox.warning(self,"错误","当前文件夹下\n未找到托盘图片")
                return
            self.window().hide()
