...
- 使用示例:
    ...
    win = cure.Windows(Examples(), 'tray name', 'tray.jpg', 'pink', 'program name', 'myicon.ico')
    sys.exit(app.exec_())
"""
RESOURCE_DIR = 'beautifyUi'

def Windows(mainWidget, icon_name, icon_jpg, theme=None, title='QCureWindow', ico_path=''):
    """
    快速创建彩色窗 (带TitleBar)
    :param mainWidget:
    :param theme:
    ...
    coolWindow = WindowWithTitleBar.WindowWithTitleBar(mainWidget, icon_name, icon_jpg)
