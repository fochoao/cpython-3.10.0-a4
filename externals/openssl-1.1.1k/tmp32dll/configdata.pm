...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython\\externals\\openssl-1.1.1k\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1k\\Configurations\\10-main.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
