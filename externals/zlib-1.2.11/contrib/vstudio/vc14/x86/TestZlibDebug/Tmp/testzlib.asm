...
$SG97078 DB	'rb', 00H
	ORG $+5
$SG97139 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG97142 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG97143 DB	'file %s read, %u bytes', 0aH, 00H
$SG97147 DB	'1.2.11', 00H
	ORG $+1
$SG97148 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG97149 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG97150 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG97151 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG97152 DB	'1.2.11', 00H
	ORG $+1
$SG97153 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG97154 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG97155 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG97156 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG97159 DB	'compare ok', 0aH, 00H
_DATA	ENDS
