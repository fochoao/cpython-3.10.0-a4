...
_DATA	SEGMENT
$SG94120 DB	'1.2.11', 00H
	ORG $+1
$SG94680 DB	'incorrect header check', 00H
	ORG $+1
$SG94682 DB	'unknown compression method', 00H
	ORG $+1
$SG94686 DB	'invalid window size', 00H
$SG94690 DB	'unknown compression method', 00H
	ORG $+1
$SG94692 DB	'unknown header flags set', 00H
	ORG $+3
$SG94739 DB	'header crc mismatch', 00H
$SG94756 DB	'invalid block type', 00H
	ORG $+1
$SG94760 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG94772 DB	'too many length or distance symbols', 00H
$SG94776 DB	'invalid code lengths set', 00H
	ORG $+3
$SG94786 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG94792 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG94795 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG94797 DB	'invalid literal/lengths set', 00H
$SG94799 DB	'invalid distances set', 00H
	ORG $+2
$SG94813 DB	'invalid literal/length code', 00H
$SG94824 DB	'invalid distance code', 00H
	ORG $+2
$SG94834 DB	'invalid distance too far back', 00H
	ORG $+2
$SG94847 DB	'incorrect data check', 00H
	ORG $+3
$SG94852 DB	'incorrect length check', 00H
_DATA	ENDS
...
; 204  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG94120[edx]
	cmp	eax, ecx
...
; 681  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG94680
...
; 686  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG94682
...
; 695  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG94686
...
; 710  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG94690
...
; 715  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG94692
...
; 823  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG94739
...
; 882  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG94756
...
; 891  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG94760
...
; 930  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG94772
...
; 952  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG94776
...
; 975  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG94786
...
; 998  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG94792
...
; 1012 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG94795
...
; 1026 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG94797
...
; 1035 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG94799
...
; 1087 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG94813
...
; 1123 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG94824
...
; 1153 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG94834
...
; 1212 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG94847
...
; 1225 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG94852
